...
public class CoinTypeSelectorDialog extends Dialog {
     ...
     */
    public void setCurrentCoinData(Web3ConfigEntity.WalletNetworkConfigEntityItem currentCoinData) {
        mSelectorCoinAdapter.setCurrentCoinData(currentCoinData);
    }

    public interface CoinTypeSelectorDialogListener {
        void selectorCoinData(Web3ConfigEntity.WalletNetworkConfigEntityItem data);
    }
