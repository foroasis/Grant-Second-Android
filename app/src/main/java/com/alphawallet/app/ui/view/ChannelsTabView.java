...
public class ChannelsTabView extends FrameLayout {
    ...
    public ChannelsTabView(@NonNull BaseFragment dialogsActivity) {
    ...
    private void initView() {
        ...
        binding.ivDrawerMenu.setImageResource(R.drawable.calls_back_black);
    ...
    private void getChannelTag() {
        ...
        for (int i = 0; i < tagList.size(); i++) {
            ...
            ChannelFeedFragment pageFragment = ChannelFeedFragment.instance(entity);
    ...
    public void onEventInfo(MessageEvent messageEvent) {
        switch (messageEvent.getType()) {
            case EventBusTags.CHANNEL_TAG_REFRESH:
                //标签栏有变化
                getChannelTag();
                break;

            case EventBusTags.CHANNEL_WITH_TAG_REFRESH:
                //tag下的channel有变化
