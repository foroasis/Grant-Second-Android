...
public class SettingWalletCell extends ConstraintLayout {
    ...
    private void initView() {
        ...
        binding.rvBindingWallet.setOnClickListener(view -> {
            new WalletOperaDialog(getContext(), WalletDaoUtils.getCurrent().getAddress(), new WalletOperaDialog.WalletOperaDialogListener() {
                @Override
...
//        } else {
//            binding.tvWalletAddress.setText(WalletUtil.formatAddress(WalletDaoUtils.getCurrent().getAddress()));
