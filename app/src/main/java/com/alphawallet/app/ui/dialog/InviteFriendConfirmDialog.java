 ...
 * 描述：红包拉新确认
 */
public class InviteFriendConfirmDialog extends BaseAlertDialog {

    private DialogInviteFriendConfirmBinding binding;
    private InviteConfigEntity.Level level;
    private List<TLRPC.User> users;

    public InviteFriendConfirmDialog(Context context, InviteConfigEntity.Level level, List<TLRPC.User> users, OnCloseListener onCloseListener) {
