...
public class TokenTypeSelectorDialog extends Dialog {
     ...
     * @param list
     */
    public void setList(List<Web3ConfigEntity.WalletNetworkConfigEntityItem> list) {
     ...
     */
    public void setCurrentTokenData(Web3ConfigEntity.WalletNetworkConfigEntityItem currentTokenData) {
        mSelectorTokenAdapter.setCurrentCoinData(currentTokenData);
    }

    public interface TokenTypeSelectorDialogListener {
        void selectorTokenData(Web3ConfigEntity.WalletNetworkConfigEntityItem data);
    }
}
